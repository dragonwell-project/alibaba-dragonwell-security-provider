...
import org.conscrypt.net.ssl.interop.OpenSSLServer;
 ...
 */
public class BaBaSSLServerJdkDragonClientTest {
    ...
    private JdkProcDragonClient createProcClient(
    ...
    private void resumeSession(
        ...
        try (Server server = serverBuilder.build()) {
            ...
            try (JdkDragonClient client = createClient(
                    certTuple, clientProtocol,
                    clientCipherSuite, clientNamedGroup,
    ...
    private JdkDragonClient createClient(
            CertTuple certTuple, Protocol protocol,
            CipherSuite cipherSuite, NamedGroup namedGroup,
            SignatureScheme signatureScheme,
