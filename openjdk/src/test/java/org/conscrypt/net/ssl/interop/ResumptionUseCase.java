...
public class ResumptionUseCase extends ExtUseCase {
    ...
    private boolean enableServerSessionTicket = Boolean
            .getBoolean("com.tencent.kona.ssl.server.enableSessionTicketExtension");

    private boolean enableClientSessionTicket = Boolean
            .getBoolean("com.tencent.kona.ssl.client.enableSessionTicketExtension");
