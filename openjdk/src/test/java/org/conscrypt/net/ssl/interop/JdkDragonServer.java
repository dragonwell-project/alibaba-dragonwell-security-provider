 ...
 */
public class JdkDragonServer extends AbstractServer {
    ...
    public JdkDragonServer(Builder builder) throws Exception {
        response = builder.getMessage();

        context = Utilities.createSSLContext(
                Jdk.DRAGON_PROVIDER, builder.getContextProtocol(), builder.getCertTuple());
        SSLServerSocketFactory serverFactory = context.getServerSocketFactory();
        serverSocket = (SSLServerSocket) serverFactory.createServerSocket(builder.getPort());
    ...
    public static class Builder extends AbstractServer.Builder {
        ...
        @Override
        public JdkDragonServer build() throws Exception {
            return new JdkDragonServer(this);
        }
    }
