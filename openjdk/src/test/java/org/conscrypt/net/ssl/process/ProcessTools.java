...
package org.conscrypt.net.ssl.process;
...
import org.conscrypt.net.ssl.common.JDKToolFinder;
import org.conscrypt.net.ssl.common.Utils;
...
public final class ProcessTools {
     ...
     * 
     * @param name           The process name
     * @param consumer       {@linkplain Consumer} instance to process the
     *                       in-streams
     * @param processBuilder The process builder
     * @return Returns the initialized process
     * @throws IOException
     ...
     * @param timeout        The timeout for the warmup waiting; -1 = no wait; 0 =
     *                       wait forever
     ...
     * @param name           The process name
     * @param processBuilder The process builder
     * @param lineConsumer   The {@linkplain Consumer} the lines will be forwarded
     *                       to
     * @param linePredicate  The {@linkplain Predicate} to use on the STDOUT
     *                       Used to determine the moment the target app is
     *                       properly warmed-up.
    ...
    /**
     * Executes a test jvm process, waits for it to finish and returns the process
     * output.
     * The default jvm options from jtreg, test.vm.opts and test.java.opts, are
     * added.
    ...
    /**
     * Used to log command line, stdout, stderr and exit code from an executed
     * process.
     * 
