...
public abstract class BaseInteropTest<U extends UseCase> {
    ...
    protected Status runTestCase(TestCase<U> testCase) throws Exception {
        ...
        Status caseStatus = serverStatus == Status.PASS && clientStatus == Status.PASS
                ? Status.PASS
                : Status.FAIL;
        System.out.printf(
    ...
    /*
     * Return a server once it is properly started to avoid client connection
     * issues.
