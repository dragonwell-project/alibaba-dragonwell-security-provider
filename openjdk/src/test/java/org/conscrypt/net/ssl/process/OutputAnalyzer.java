...
public final class OutputAnalyzer {
    ...
    /**
     * Verify that the stdout and stderr contents of output buffer does not contain
     * the string
     *
     ...
     * @throws RuntimeException If the exit value from the process did not match the
     *                          expected value
     */
     ...
     * @throws RuntimeException If the exit value from the process did match the
     *                          expected value
     */
    ...
    /**
     * Verifies that the stdout and stderr contents of output buffer are empty,
     * after
