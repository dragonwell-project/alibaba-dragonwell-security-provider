...
public class ProcUtils {
    ...
    /*
     * Executes a command, redirects the output to a local file and returns the
     * process.
     */
    private static Process startAndGetProc(String[] cmds, Path outputPath, Map<String, String> env) throws IOException {
