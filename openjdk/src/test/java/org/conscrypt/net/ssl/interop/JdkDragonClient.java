 ...
 */
public class JdkDragonClient extends AbstractClient {
    ...
    public JdkDragonClient(Builder builder) throws Exception {
    ...
    public static class Builder extends AbstractClient.Builder {
        ...
        @Override
        public JdkDragonClient build() throws Exception {
            return new JdkDragonClient(this);
        }
    }
