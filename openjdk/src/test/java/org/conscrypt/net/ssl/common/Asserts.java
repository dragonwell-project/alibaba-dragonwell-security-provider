...
public class Asserts {
     ...
     * @param lhs The left hand side of the comparison.
     * @param rhs The right hand side of the comparison.
     * @param msg A description of the assumption; {@code null} for a default
     *            message.
    ...
    /**
     * Calls {@link #assertLessThan(Comparable, Comparable, String)} with a default
     * message.
     *
     * @param <T> a type
     * @param lhs The left hand side of the comparison.
    ...
    /**
     * Calls {@link #assertLessThanOrEqual(Comparable, Comparable, String)} with a
     * default message.
     *
     * @param <T> a type
     * @param lhs The left hand side of the comparison.
    ...
    /**
     * Calls
     * {@link #assertEquals(java.lang.Object, java.lang.Object, java.lang.String)}
    ...
    /**
     * Calls
     * {@link #assertSame(java.lang.Object, java.lang.Object, java.lang.String)}
     * with a default message.
     *
     * @param lhs The left hand side of the comparison.
     * @param rhs The right hand side of the comparison.
    ...
    /**
     * Shorthand for
     * {@link #assertGreaterThanOrEqual(Comparable, Comparable, String)}.
     *
     * @param <T> a type
     * @param lhs The left hand side of the comparison.
     * @param rhs The right hand side of the comparison.
    ...
    /**
     * Calls {@link #assertGreaterThanOrEqual(Comparable, Comparable, String)} with
     * a default message.
     *
     * @param <T> a type
     * @param lhs The left hand side of the comparison.
    ...
    /**
     * Calls {@link #assertGreaterThan(Comparable, Comparable, String)} with a
     * default message.
     *
     * @param <T> a type
     * @param lhs the left hand value
    ...
    /**
     * Calls {@link #assertNotEquals(Object, Object, String)} with a default
     * message.
     *
     * @param lhs The left hand side of the comparison.
     * @param rhs The right hand side of the comparison.
    ...
    public static void assertStringsEqual(String str1, String str2,
        ...
        for (int line = 0; line < minLength; line++) {
            if (!str1Lines[line].equals(str2Lines[line])) {
                messageBuilder.append(String.format("[line %d] '%s' differs " +
                        "from '%s'\n",
                        line,
                        str1Lines[line],
                        str2Lines[line]));
        ...
        if (minLength < longestStringLines.length) {
            ...
            for (int line = minLength; line < longestStringLines.length; line++) {
                messageBuilder.append(String.format("[line %d] '%s'", line,
