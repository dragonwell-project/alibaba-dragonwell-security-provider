...
public class OpenSSLX509CertificateTest extends TestCase {
    ...
    public void test_LoadSM2PrivateKey()throws Exception{
        PrivateKey privateKey = readSM2PrivateKeyPemFile("sm2/sm2-private.key");
    ...
    public void test_BuildSM2CertificatChain()throws Exception{
        ...
        X509Certificate crtCert = OpenSSLX509Certificate.fromX509PemInputStream(openTestFile("sm2/sm2-cert.crt"));
        PrivateKey privateKey = readSM2PrivateKeyPemFile("sm2/sm2-private.key");
