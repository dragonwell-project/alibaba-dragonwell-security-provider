...
public final class MessageDigestTest {
    ...
    static {
        ...
        putExpectation("SM3",
                       INPUT_EMPTY,
                       new byte[] { 26, -78, 29, -125, 85, -49, -95, 127,
                                    -114, 97, 25, 72, 49, -24, 26, -113,
                                    34, -66, -56, -57, 40, -2, -5, 116,
                                    126, -48, 53, -21, 80, -126, -86, 43 });
        ...
        if (System.getenv("ANDROID_BUILD_TOP") != null) {
            ...
            putExpectation("SM3",
                           INPUT_256MB,
                           new byte[] { 75, 74, -43, 22, 76, 101, 93, 85,
                                        55, 64, -17, 55, 79, 45, -61, -55,
                                        -36, -50, -117, -13, -19, 53, -13, -91,
                                        89, -66, 42, 122, -93, -61, -77, 119 });
        }
    }
