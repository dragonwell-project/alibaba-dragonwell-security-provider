...
#include <conscrypt/cryptoutil.h>
...
// Define tls1.3 supported cipher suits, include RFC8998.
...
static const SSL_SIGNATURE_ALGORITHM kSignatureAlgorithms[] = {
    ...
    {SSL_SIGN_RSA_PKCS1_MD5_SHA1, EVP_PKEY_RSA, NID_undef, &EVP_md5_sha1, false},
    ...
    {SSL_SIGN_ECDSA_SECP256R1_SHA256, EVP_PKEY_EC, NID_X9_62_prime256v1, &EVP_sha256, false},
    {SSL_SIGN_ECDSA_SECP384R1_SHA384, EVP_PKEY_EC, NID_secp384r1, &EVP_sha384, false},
    {SSL_SIGN_ECDSA_SECP521R1_SHA512, EVP_PKEY_EC, NID_secp521r1, &EVP_sha512, false},
...
// Make method create_bio_meth multi-thread safe.
static std::atomic<BIO_METHOD*> stream_bio_method = nullptr;
static std::mutex bio_method_mutex;
static BIO_METHOD *create_bio_meth(void) {
    if (stream_bio_method == nullptr) {
        std::lock_guard<std::mutex> mutx(bio_method_mutex);
        if (stream_bio_method == nullptr) {
...
// ssl_CIPHER_get_kx_name convert from boringssl to tongsuo.
