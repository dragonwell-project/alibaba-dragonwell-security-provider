...
public final class DragonwellSecurity {
    private DragonwellSecurity() {};

    /**
     * Returns {@code true} if the DragonwellSecurity native library has been successfully loaded.
     */
    ...
    static {
        ...
        try {
            stream = DragonwellSecurity.class.getResourceAsStream("dragonwell_security.properties");
            if (stream != null) {
                Properties props = new Properties();
                props.load(stream);
                major = Integer.parseInt(props.getProperty("com.alibaba.dragonwell.security.version.major", "-1"));
                minor = Integer.parseInt(props.getProperty("com.alibaba.dragonwell.security.version.minor", "-1"));
                patch = Integer.parseInt(props.getProperty("com.alibaba.dragonwell.security.version.patch", "-1"));
            }
        } catch (IOException e) {
    ...
    /**
     * Returns the version of this distribution of Dragonwell Security.  If version information is
    ...
    /**
     * Checks that the DragonwellSecurity support is available for the system.
     *
    ...
    /**
     * Indicates whether the given {@link Provider} was created by this distribution of Dragonwell Security.
     */
    public static boolean isDragonwellSecurity(Provider provider) {
        return provider instanceof DragonwellSecurityProvider;
    }

    /**
     * Constructs a new {@link Provider} with the default name.
     */
    public static Provider newProvider() throws Exception {
        checkAvailability();
        return new DragonwellSecurityProvider();
    }

    public static class ProviderBuilder {
        private String name = DragonwellSecurityProvider.NAME;
        private boolean provideTrustManager = true;
        private String defaultTlsProtocol = DragonwellSecurityProvider.DEFAULT_TLS_PROTOCOL;
        ...
        public Provider build() {
            return new DragonwellSecurityProvider(name, provideTrustManager, defaultTlsProtocol);
        }
    }
    ...
    public static int maxEncryptedPacketLength() {
        return Conscrypt.maxEncryptedPacketLength();
    }
    ...
    /**
     * Indicates whether the given {@link SSLContext} was created by this distribution of Dragonwell Security.
     */
    public static boolean isDragonwellSecurity(SSLContext context) {
        return context.getProvider() instanceof DragonwellSecurityProvider;
    }
    ...
    public static SSLContextSpi newPreferredSSLContextSpi() {
        return Conscrypt.newPreferredSSLContextSpi();
    }
    ...
    public static void setClientSessionCache(SSLContext context, SSLClientSessionCache cache) {
        ...
        if (!(clientContext instanceof ClientSessionContext)) {
            throw new IllegalArgumentException(
                    "Not a dragonwell security client context: " + clientContext.getClass().getName());
        }
    ...
    public static void setServerSessionCache(SSLContext context, SSLServerSessionCache cache) {
        ...
        if (!(serverContext instanceof ServerSessionContext)) {
            throw new IllegalArgumentException(
                    "Not a dragonwell security client context: " + serverContext.getClass().getName());
        }
     ...
     * Dragonwell Security.
     */
    public static boolean isDragonwellSecurity(SSLSocketFactory factory) {
        return Conscrypt.isConscrypt(factory);
    }
     ...
     * of Conscrypt.
     */
    public static boolean isDragonwellSecurity(SSLServerSocketFactory factory) {
        return Conscrypt.isConscrypt(factory);
    }
    ...
    /**
     * Indicates whether the given {@link SSLSocket} was created by this distribution of Dragonwell Security.
     */
    public static boolean isDragonwellSecurity(SSLSocket socket) {
    ...
    public static String getHostname(SSLSocket socket) {
        return Conscrypt.getHostname(socket);
    }
    ...
    public static String getHostnameOrIP(SSLSocket socket) {
        return Conscrypt.getHostnameOrIP(socket);
    }
    ...
    public static void setChannelIdEnabled(SSLSocket socket, boolean enabled) {
        Conscrypt.setChannelIdEnabled(socket, enabled);
    }
     ...
     * completed.
     * @throws Exception if channel ID is available but could not be obtained.
     */
    public static byte[] getChannelId(SSLSocket socket) throws SSLException {
        return Conscrypt.getChannelId(socket);
    }
    ...
    public static void setChannelIdPrivateKey(SSLSocket socket, PrivateKey privateKey) {
        Conscrypt.setChannelIdPrivateKey(socket, privateKey);
    }
    ...
    public static void setApplicationProtocolSelector(SSLSocket socket,
        ...
        Conscrypt.setApplicationProtocolSelector(socket, selector);
    }
    ...
    public static byte[] getTlsUnique(SSLSocket socket) {
        return Conscrypt.getTlsUnique(socket);
    }
    ...
    /**
     * Indicates whether the given {@link SSLEngine} was created by this distribution of Dragonwell Security.
     */
    public static boolean isDragonwellSecurity(SSLEngine engine) {
    ...
    public static void setBufferAllocator(SSLEngine engine, BufferAllocator bufferAllocator) {
        Conscrypt.setBufferAllocator(engine, bufferAllocator);
    }
    ...
    public static void setBufferAllocator(SSLSocket socket, BufferAllocator bufferAllocator) {
        Conscrypt.setBufferAllocator(socket, bufferAllocator);
    }
    ...
    public static void setDefaultBufferAllocator(BufferAllocator bufferAllocator) {
        Conscrypt.setDefaultBufferAllocator(bufferAllocator);
    }
    ...
    public static void setHostname(SSLEngine engine, String hostname) {
        Conscrypt.setHostname(engine, hostname);
    }
    ...
    public static String getHostname(SSLEngine engine) {
        return Conscrypt.getHostname(engine);
    }
    ...
    public static void setHandshakeListener(SSLEngine engine, HandshakeListener handshakeListener) {
        Conscrypt.setHandshakeListener(engine, handshakeListener);
    }
    ...
    public static void setChannelIdEnabled(SSLEngine engine, boolean enabled) {
        Conscrypt.setChannelIdEnabled(engine, enabled);
    }
    ...
    public static byte[] getChannelId(SSLEngine engine) throws SSLException {
        return Conscrypt.getChannelId(engine);
    }
    ...
    public static void setChannelIdPrivateKey(SSLEngine engine, PrivateKey privateKey) {
        Conscrypt.setChannelIdPrivateKey(engine, privateKey);
    }
    ...
    public static SSLEngineResult unwrap(SSLEngine engine, final ByteBuffer[] srcs,
        ...
        return Conscrypt.unwrap(engine, srcs, dsts);
    }
    ...
    public static SSLEngineResult unwrap(SSLEngine engine, final ByteBuffer[] srcs, int srcsOffset,
        ...
        return Conscrypt.unwrap(engine, srcs, srcsOffset, srcsLength, dsts, dstsOffset, dstsLength);
    }
    ...
    public static void setApplicationProtocolSelector(SSLEngine engine,
        ApplicationProtocolSelector selector) {
        Conscrypt.setApplicationProtocolSelector(engine, selector);
    }
    ...
    public static byte[] getTlsUnique(SSLEngine engine) {
        return Conscrypt.getTlsUnique(engine);
    }
     ...
     * Dragonwell Security.
     */
    public static boolean isDragonwellSecurity(TrustManager trustManager) {
        return Conscrypt.isConscrypt(trustManager);
    }
    ...
    public synchronized static void setDefaultHostnameVerifier(ConscryptHostnameVerifier verifier) {
        Conscrypt.setDefaultHostnameVerifier(verifier);
    }
    ...
    public synchronized static ConscryptHostnameVerifier getDefaultHostnameVerifier(TrustManager trustManager) {
        return Conscrypt.getDefaultHostnameVerifier(trustManager);
    }
    ...
    public static void setHostnameVerifier(TrustManager trustManager, ConscryptHostnameVerifier verifier) {
        Conscrypt.setHostnameVerifier(trustManager, verifier);
    }
     ...
     */
    public static ConscryptHostnameVerifier getHostnameVerifier(TrustManager trustManager) throws Exception {
        return Conscrypt.getHostnameVerifier(trustManager);
    }
