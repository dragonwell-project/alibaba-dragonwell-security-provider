...
public final class DragonwellSecurityProvider extends Provider {
    private static final long serialVersionUID = 1L;

    private static final String PREFIX = OpenSSLProvider.class.getPackage().getName() + ".";
    private static final String PLATFORM = PREFIX + "Platform";
    private static final String TRUST_MANAGER_FACTORY_IMPL = PREFIX + "TrustManagerFactoryImpl";
    private static final String KEY_MANAGER_FACTORY_IMPL = PREFIX + "KeyManagerFactoryImpl";
    ...
    static final String DEFAULT_TLS_PROTOCOL = "TLSv1.3";

    public static final String NAME = "Dragonwell";
    // VERSION_NUM is align with Tongsuo openssl version number.
    private static final double VERSION_NUM = 1.0;
    private static final String INFO = "Dragonwell Security Provider: "
            + "A High Performance Java Security Provider Which Supports ShangMi Crypto, PKI and Secure Protocols";

    public DragonwellSecurityProvider() {
        this(NAME, true, DEFAULT_TLS_PROTOCOL);
    }

    DragonwellSecurityProvider(String name, boolean includeTrustManager, String defaultTlsProtocol) {
        super(name, VERSION_NUM, INFO);

        // Ensure that the native library has been loaded.
        DragonwellSecurity.checkAvailability();
        ...
        if (includeTrustManager) {
            put("TrustManagerFactory.PKIX", TRUST_MANAGER_FACTORY_IMPL);
            put("Alg.Alias.TrustManagerFactory.X509", "PKIX");
        }

        put("KeyManagerFactory.PKIX", KEY_MANAGER_FACTORY_IMPL);
    ...
    private void platformSetup() {
        try {
            ...
            Method method = cls.getDeclaredMethod("setup");
